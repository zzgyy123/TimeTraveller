...
public static class IOHelper
{
    ...
    public static void SetData(string fileName, object pObject,bool isEncypt=true)
    {
        //将对象序列化为字符串
    ...
    public static object GetData(string fileName, Type pType,bool isDencypt=true)
    {
