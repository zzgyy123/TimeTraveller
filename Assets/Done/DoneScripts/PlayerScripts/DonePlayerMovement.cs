...
public class DonePlayerMovement : MonoBehaviour
{
	...
	void Update ()
	{
        ...
        SpeedRatio = Mathf.Sin(Mathf.PI*timeController.TimeRatio);
        //Debug.Log("time:"+timeController.CurrentSpanTime+"  ratio:"+ SpeedRatio);
        targetSpeed = SpeedRatio * MaxSpeed;
	...
	void MovementManagement (float horizontal, float vertical, bool sneaking)
	{
		...
		if(horizontal != 0f || vertical != 0f)
		{
			...
			anim.SetFloat(hash.speedFloat, targetSpeed, speedDampTime, Time.deltaTime);
		}
		else
